...
//        self.applePayService = try ApplePayService(apiKey: "pk_live_CmFxem25RynGD2RexTFWxLFNJpfUDAcUrFza9PJj")
//    }
//
//    func present() {
//        items = [
...
//        request.merchantIdentifier = "merchant.bcareLive2021.id" // "merchant.mysr.fghurayri"
